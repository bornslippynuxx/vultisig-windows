...
import { ManageFee } from '@core/ui/vault/send/verify/ManageFee'
...
import { useSdkSendKeysignPayloadQuery } from './useSdkSendKeysignPayloadQuery'

const sendTerms = ['send_terms_1', 'send_terms_0'] as const

export const SdkSendVerify: FC<OnBackProp> = ({ onBack }) => {
  ...
  const keysignPayloadQuery = useSdkSendKeysignPayloadQuery({
    feeSettings,
  })
