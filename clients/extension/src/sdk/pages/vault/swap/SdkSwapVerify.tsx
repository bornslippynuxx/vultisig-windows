...
import { useSdkSwapKeysignPayloadQuery } from './useSdkSwapKeysignPayloadQuery'

const swapTerms = ['input', 'output'] as const

type SdkSwapVerifyProps = {
  swapQuote: SwapQuote
} & OnBackProp

export const SdkSwapVerify: FC<SdkSwapVerifyProps> = ({
  swapQuote,
  onBack,
}) => {
  ...
  const keysignPayloadQuery = useSdkSwapKeysignPayloadQuery(swapQuote)
