...
// Import the actual DKLS WASM library (temporarily disabled for testing)
// import { SignSession, Keyshare, Message } from '../../../../lib/dkls/vs_wasm'
// import initDklsWasm from '../../../../lib/dkls/vs_wasm'
...
export class DklsKeysignSession {
  ...
  async executeKeysign(): Promise<SigningResult> {
    ...
    try {
      // Initialize DKLS WASM (temporarily disabled)
      // await initDklsWasm()
