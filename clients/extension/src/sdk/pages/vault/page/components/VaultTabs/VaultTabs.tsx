import { SearchChainProvider } from '@core/ui/vault/page/state/searchChainProvider'
import { VaultTabsHeader } from '@core/ui/vault/page/components/VaultTabs/VaultTabsHeader'
